...
fitStartingOverrides=<|
  "AZ"-><|"rlower"->3,"rupper"->5,"tlower"->50,"tupper"->75,"replower"->0.52,"repupper"->0.6,"powlower"->1.4,"powupper"->3|>,
  "CA"-><|"rlower"->3.1,"rupper"->4.5,"tlower"->35,"tupper"->55,"replower"->0.5,"repupper"->0.6,"powlower"->1.6,"powupper"->2.5|>,
  ...
  "OH"-><|"rlower"->3.9,"rupper"->4.8,"tlower"->54,"tupper"->57,"replower"->0.2,"repupper"->0.4,"powlower"->2.2,"powupper"->2.6|>,
  ...
  "LA"-><|"rlower"->4.1,"rupper"->4.5,"tlower"->41.5,"tupper"->50,"replower"->0.25,"repupper"->0.4,"powlower"->2.4,"powupper"->3|>,
  ...
  "MA"-><| "rlower"->4.3,"rupper"->5,"tlower"->44,"tupper"-> 53,"replower"->0.3,"repupper"->0.5,"powlower"->1.3,"powupper"->2.5|>,
  "MD"-><|"rlower"->4.5,"rupper"->5,"tlower"->55,"tupper"->59,"replower"->0.25,"repupper"->0.3,"powlower"->1.9,"powupper"->2.4|>,
  ...
  "IN"-><|"rlower"->4.3,"rupper"->5,"tlower"->35,"tupper"->62,"replower"->0.2,"repupper"->0.25,"powlower"->2.5,"powupper"->3|>,
  ...
  "SC"-><|"rlower"->4,"rupper"->4.6,"tlower"->35,"tupper"->58,"replower"->0.65,"repupper"->1,"powlower"->2.8,"powupper"->3.4|>(*,
