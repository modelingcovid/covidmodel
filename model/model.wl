...
fitStartingOverrides=<|
  ...
  "MS"-><|"rlower"->2.7,"rupper"->5,"tlower"->45,"tupper"->55,"replower"->0.45,"repupper"->0.55,"powlower"->2.5,"powupper"->3.1|>,
  ...
  "SC"-><|"rlower"->3,"rupper"->5,"tlower"->35,"tupper"->55,"replower"->0.65,"repupper"->1,"powlower"->2.7,"powupper"->2.8|>(*,
