...
fitStartingOverrides=<|
  "AZ"-><|"rlower"->3,"rupper"->5,"tlower"->35,"tupper"->75,"replower"->0.45,"repupper"->0.65,"powlower"->1.8,"powupper"->2.5|>,
  "CA"-><|"rlower"->3.1,"rupper"->4.5,"tlower"->35,"tupper"->55,"replower"->0.55,"repupper"->0.7,"powlower"->1.7,"powupper"->2.5|>,
  "FL"-><|"rlower"->3.6,"rupper"->4.2,"tlower"->38,"tupper"->75,"replower"->1.1,"repupper"->1.25,"powlower"->1.8,"powupper"->2.5|>,
  "PA"-><|"rlower"->4.8,"rupper"->5,"tlower"->54,"tupper"->75,"replower"->0.8,"repupper"->1.1,"powlower"->2,"powupper"->2.5|>,
  "CO"-><|"rlower"->3.3,"rupper"->5,"tlower"->49,"tupper"->55,"replower"->0.5,"repupper"->0.55,"powlower"->1.8,"powupper"->2.5|>,
  "TX"-><|"rlower"->4.8,"rupper"->5,"tlower"->42,"tupper"->55.5,"replower"->0.9,"repupper"->1,"powlower"->2.9,"powupper"->3.2|>,
  "WA"-><|"rlower"->2,"rupper"->3.5,"tlower"->10,"tupper"->15,"replower"->0.8,"repupper"->0.9,"powlower"->1.5,"powupper"->2.2|>,
  "CT"-><|"rlower"->4.8,"rupper"->5,"tlower"->51,"tupper"->57,"replower"->0.15,"repupper"->0.2,"powlower"->1.9,"powupper"->2.6|>,
  ...
  "VA"-><|"rlower"->3.7,"rupper"->4.2,"tlower"->35,"tupper"->52.5,"replower"->0.2,"repupper"->0.6,"powlower"->1.6,"powupper"->1.8|>,
  ...
  "MS"-><|"rlower"->2.7,"rupper"->5,"tlower"->45,"tupper"->75,"replower"->0.45,"repupper"->0.6,"powlower"->2.1,"powupper"->2.9|>,
  "MA"-><| "rlower"->4.3,"rupper"->5,"tlower"->49,"tupper"-> 53,"replower"->0.3,"repupper"->0.45,"powlower"->1.8,"powupper"->2.5|>,
  "MD"-><|"rlower"->4.5,"rupper"->5,"tlower"->55,"tupper"->59,"replower"->0.35,"repupper"->0.5,"powlower"->1.7,"powupper"->2.4|>,
  ...
  "IL"-><|"rlower"->4.6,"rupper"->5,"tlower"->35,"tupper"->75,"replower"->0.4,"repupper"->0.48,"powlower"->1.8,"powupper"->2.6|>,
  "IN"-><|"rlower"->4.3,"rupper"->5,"tlower"->35,"tupper"->62,"replower"->0.25,"repupper"->0.35,"powlower"->2.5,"powupper"->3|>,
  "OK"-><|"rlower"->3.2,"rupper"->4,"tlower"->35,"tupper"->58,"replower"->0.3,"repupper"->0.4,"powlower"->3.3,"powupper"->3.5|>,
  "WI"-><|"rlower"->3.4,"rupper"->4.3,"tlower"->35,"tupper"->75,"replower"->0.5,"repupper"->0.6,"powlower"->2.3,"powupper"->2.7|>,
  "NV"-><|"rlower"->3.6,"rupper"->4.3,"tlower"->48,"tupper"->75,"replower"->0.55,"repupper"->0.65,"powlower"->1.6,"powupper"->2|>,
  "OR"-><|"rlower"->2.8,"rupper"->4,"tlower"->35,"tupper"->55,"replower"->0.8,"repupper"->1.05,"powlower"->1.8,"powupper"->2.6|>,
  "SC"-><|"rlower"->4,"rupper"->4.6,"tlower"->35,"tupper"->58,"replower"->0.75,"repupper"->1.4,"powlower"->2.8,"powupper"->3.4|>(*,
