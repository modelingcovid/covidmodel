...
fitStartingOverrides=<|
  "AZ"-><|"rlower"->3,"rupper"->5,"tlower"->35,"tupper"->75,"replower"->0.52,"repupper"->0.65,"powlower"->2.3,"powupper"->3|>,
  ...
  "CO"-><|"rlower"->3.3,"rupper"->5,"tlower"->49,"tupper"->55,"replower"->0.45,"repupper"->0.52,"powlower"->1.8,"powupper"->2.5|>,
  ...
  "MD"-><|"rlower"->4.5,"rupper"->5,"tlower"->55,"tupper"->59,"replower"->0.35,"repupper"->0.5,"powlower"->1.9,"powupper"->2.4|>,
  ...
  "IL"-><|"rlower"->4.6,"rupper"->5,"tlower"->35,"tupper"->75,"replower"->0.4,"repupper"->0.48,"powlower"->2.1,"powupper"->2.6|>,
  "IN"-><|"rlower"->4.3,"rupper"->5,"tlower"->35,"tupper"->62,"replower"->0.2,"repupper"->0.3,"powlower"->2.5,"powupper"->3|>,
  "OK"-><|"rlower"->3.2,"rupper"->4,"tlower"->35,"tupper"->58,"replower"->0.3,"repupper"->0.4,"powlower"->3.3,"powupper"->3.5|>,
  "WI"-><|"rlower"->3.4,"rupper"->4.3,"tlower"->35,"tupper"->51,"replower"->0.45,"repupper"->0.6,"powlower"->2.3,"powupper"->2.7|>,
  "NV"-><|"rlower"->3.6,"rupper"->4.3,"tlower"->48,"tupper"->75,"replower"->0.55,"repupper"->0.65,"powlower"->1.6,"powupper"->2|>,
  "OR"-><|"rlower"->2.8,"rupper"->4,"tlower"->35,"tupper"->55,"replower"->0.8,"repupper"->1,"powlower"->1.8,"powupper"->2.6|>,
